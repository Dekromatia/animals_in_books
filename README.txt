...
и чем жиренее узел (он ароде по степени создавался)
Цвета примерно покаывают набор разных животных(предположительно)

Возможно стоило сгруппировать животных в группы по географическому признаку

так же из люопытства я урезала список 2 раза
1 раз оставив животных которые упоминаются в 50% книг из корпуса (примерно 30)
тут более менее видно что у Дарелла животные отличаются от других (возможно потому что он был директором зоопарка набор был разнообразнее)
красным видимо те у кого наименьшее разнообразие
но в основном все синее
занимательно что эти результаты перекликаются с результатами исследования в стайло(особенно видно по крвсным точкам)

2 раз оставив тех животнвх которые хотя бы есть в 50 книгах 
Получилось 5 самых часто встречаемых в текстах животных: мышь, лошадь, кошка, змея, собака 
Стоило раскрасить граф в большее количество цветов
